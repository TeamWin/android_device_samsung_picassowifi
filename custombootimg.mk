...
$(INSTALLED_RECOVERYIMAGE_TARGET): $(MKBOOTIMG) \
	...
	chmod 644 out/target/product/picassowifi/recovery/root/init.rc
	chmod 644 out/target/product/picassowifi/recovery/root/default.prop
	(cd out/target/product/picassowifi/recovery/root/ && find * | sort | cpio -o -H newc) | gzip > $(recovery_ramdisk)
